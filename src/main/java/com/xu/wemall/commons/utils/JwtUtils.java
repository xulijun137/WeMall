...
public class JwtUtils {
     ...
     * @throws Exception
     */
    public static String createJWT(String id, String subject, Lover lover){
        ...
        claims.put("userJsonString", JSONObject.toJSONString(lover));
    ...
    public static void main(String[] args) throws Exception {
        ...
        lover.setId(1);
        lover.setLoverName("Ronnie");

        String jwt=JwtUtils.createJWT("jwt", "{id:10086,name:Ronnie}", lover);
        ...
        Lover loverObject = JSONObject.parseObject(c.get("userJsonString", String.class), new TypeReference<Lover>() {});
        System.out.println(loverObject.getLoverName());//DSSFAWDWADAS...
    }
